...
class GetMapResponse(genpy.Message):
  _md5sum = "2a2a05e03192fc99c42c8a9652380236"
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        _v36 = val1.laserScanLocalTransform
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.data.nodes:
        ...
        _x = val1
        buff.write(_get_struct_ifi().pack(_x.laserScanMaxPts, _x.laserScanMaxRange, _x.laserScanFormat))
        _v57 = val1.laserScanLocalTransform
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.laserScanMaxPts, _x.laserScanMaxRange, _x.laserScanFormat,) = _get_struct_ifi().unpack(str[start:end])
        _v78 = val1.laserScanLocalTransform
        _v79 = _v78.translation
        _x = _v79
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
...
class GetMap(object):
  ...
  _md5sum = 'ad8fb2ad671681ea9f0434db9f280539'
